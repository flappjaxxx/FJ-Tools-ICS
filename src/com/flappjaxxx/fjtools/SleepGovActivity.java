...
public class SleepGovActivity extends Activity {
	...
	static final String CMD_CONSERVATIVE="conservativesleep";
	static final String CMD_USERSPACE="userspacesleep";
	static final String CMD_POWERSAVE="powersavesleep";
	static final String CMD_ONDEMAND="ondemandsleep";
	static final String CMD_PERFORMANCE="performancesleep";
	    	...
	    	public void onClick(View v) {
	        	...
	        	try {
	        		...
	        		DataOutputStream os = new DataOutputStream(p.getOutputStream());  
	        		   os.writeBytes(CMD_FJTOOL + " " + CMD_ONDEMAND + "\n" + "; exit\n");  
	        		   os.flush();  
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	    ...
	    private OnClickListener conservativeListener = new OnClickListener() {
	        public void onClick(View v) {
	        	...
	        	try {
	        		p = Runtime.getRuntime().exec(CMD_SU);
	        		DataOutputStream os = new DataOutputStream(p.getOutputStream());  
	        		   os.writeBytes(CMD_FJTOOL + " " + CMD_CONSERVATIVE + "\n" + "; exit\n");  
	        		   os.flush();  
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	    ...
	    private OnClickListener userspaceListener = new OnClickListener() {
	        public void onClick(View v) {
	        	...
	        	try {
	        		p = Runtime.getRuntime().exec(CMD_SU);
	        		DataOutputStream os = new DataOutputStream(p.getOutputStream());  
	        		   os.writeBytes(CMD_FJTOOL + " " + CMD_USERSPACE + "\n" + "; exit\n");  
	        		   os.flush();  
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	    ...
	    private OnClickListener powersaveListener = new OnClickListener() {
	        public void onClick(View v) {
	        	...
	        	try {
	        		p = Runtime.getRuntime().exec(CMD_SU);
	        		DataOutputStream os = new DataOutputStream(p.getOutputStream());  
	        		   os.writeBytes(CMD_FJTOOL + " " + CMD_POWERSAVE + "\n" + "; exit\n");  
	        		   os.flush();  
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	    ...
	    private OnClickListener performanceListener = new OnClickListener() {
	        public void onClick(View v) {
	        	...
	        	try {
	        		p = Runtime.getRuntime().exec(CMD_SU);
	        		DataOutputStream os = new DataOutputStream(p.getOutputStream());  
	        		   os.writeBytes(CMD_FJTOOL + " " + CMD_PERFORMANCE + "\n" + "; exit\n");  
	        		   os.flush();  
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
