...
public class SleepMaxActivity extends Activity {
	...
	static final String CMD_192="192sleepmax";
	static final String CMD_384="384sleepmax";
	static final String CMD_486="486sleepmax";
	static final String CMD_594="594sleepmax";
	static final String CMD_702="702sleepmax";
	static final String CMD_864="864sleepmax";
	static final String CMD_972="972sleepmax";
	static final String CMD_1134="1134sleepmax";
	static final String CMD_1350="1350sleepmax";
	static final String CMD_1512="1512sleepmax";
	  ...
	  //Create an anonymous implementation of OnClickListener
	    private OnClickListener button192Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 192000", Toast.LENGTH_SHORT).show();
	 ...
	 // Create an anonymous implementation of OnClickListener
	    private OnClickListener button486Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 486000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        } 
	    };
		 ...
		 // Create an anonymous implementation of OnClickListener
		    private OnClickListener button594Listener = new OnClickListener() {
		        public void onClick(View v) {
					...
					Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 594000", Toast.LENGTH_SHORT).show();
					SleepMaxActivity.this.finish();
		        } 
		    };
	    ...
	    private OnClickListener button702Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 702000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button864Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 864000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
		 ...
		 // Create an anonymous implementation of OnClickListener
		    private OnClickListener button972Listener = new OnClickListener() {
		        public void onClick(View v) {
					...
					Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 972000", Toast.LENGTH_SHORT).show();
					SleepMaxActivity.this.finish();
		        } 
		    };
	    ...
	    private OnClickListener button1134Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1344000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1350Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1350000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1512Listener = new OnClickListener() {
	        public void onClick(View v) {
				...
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1512000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1728Listener = new OnClickListener() {
	        public void onClick(View v) {
	        	try {
					Runtime.getRuntime().exec("su -c /system/media/tweak/1728sleepmax");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1728000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1782Listener = new OnClickListener() {
	        public void onClick(View v) {
	        	try {
					Runtime.getRuntime().exec("su -c /system/media/tweak/1782sleepmax");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1782000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1836Listener = new OnClickListener() {
	        public void onClick(View v) {
	        	try {
					Runtime.getRuntime().exec("su -c /system/media/tweak/1836sleepmax");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1836000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1890Listener = new OnClickListener() {
	        public void onClick(View v) {
	        	try {
					Runtime.getRuntime().exec("su -c /system/media/tweak/1890sleepmax");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1890000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
	    ...
	    private OnClickListener button1944Listener = new OnClickListener() {
	        public void onClick(View v) {
	        	try {
					Runtime.getRuntime().exec("su -c /system/media/tweak/1944sleepmax");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				Toast.makeText(SleepMaxActivity.this, "Sleep Max Set to 1944000", Toast.LENGTH_SHORT).show();
				SleepMaxActivity.this.finish();
	        }				
	    };
