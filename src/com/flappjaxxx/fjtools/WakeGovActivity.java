...
public class WakeGovActivity extends Activity {
	...
	static final String CMD_CONSERVATIVE="conservativewake";
	static final String CMD_USERSPACE="userspacewake";
	static final String CMD_POWERSAVE="powersavewake";
	static final String CMD_ONDEMAND="ondemandwake";
	static final String CMD_PERFORMANCE="performancewake";
